...
//!
//! ```rust,no_run
//! # #[cfg(all(feature = "spoiler", feature = "blacksmith"))]
//! # {
...
pub mod allocator {
    ...
    #[cfg(feature = "spoiler")]
    pub use swage_spoiler::{ConflictThreshold, Spoiler};
    #[cfg(feature = "thp")]
...
#[cfg(feature = "dev-mem")]
pub mod dev_mem {
    pub use swage_dev_mem::*;
}

/// Prelude module for convenient imports.
///
/// This module re-exports commonly used types and traits, allowing users to import
/// the essentials with a single `use swage::prelude::*;` statement.
pub mod prelude {
    pub use crate::allocator::ConsecAllocator;
    pub use crate::hammerer::Hammering;
    pub use crate::memory::{ConsecBlocks, MemConfiguration};
    pub use crate::util::Size;
    pub use crate::victim::VictimOrchestrator;
    pub use crate::{DataPatternKind, MemCheck, Swage, SwageConfig};
}
